...
Эти требованием отвечает одноплатный мини-
...
Приведённые данные не дали чёткую информации о преимуществах конкретного контроллера в конкретных вычислениях, для давнейшего и более удобного анализа таблица пересчитана в значения тысяч операций в секунду kOPS таблица \ref{TestTimeT2}, формула(\ref{kops}).
