...
\apendixsection{Программный код python моделирования преобразования угла поворота энкодера в суммарный угол}
...
\newpage
\apendixsection{Фрагмент кода функции обработки данных с энкодера.}
...
\newpage
\apendixsection{Фрагмент кода обновления алгоритма векторного регулирования}
...
\newpage
\apendixsection{Функция вычисления прямой кинематики}
...
\newpage
\apendixsection{Функция вычисления обратной кинематики}
